define(function (require) {
    ...
    var DialogBase = function () {
        var self = this;
        self.okKey = _i.ko.observable('');
        self.cancelKey = _i.ko.observable('');
        self.dlgData = _i.ko.observable();
    };

    DialogBase.prototype.activate = function (activationData) {
        var self = this;
        self.dlgData(activationData.data);
        self.okKey(activationData.okKey);
        self.cancelKey(activationData.cancelKey);
    ...
    DialogBase.prototype.dialogButtonClick = function (btnText, accepted, runValidation) {
        ...
        if (runValidation && self.validator()) {
